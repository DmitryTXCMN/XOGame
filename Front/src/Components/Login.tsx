...
export const Login = () => {
    ...
    const onLogin = async () => {
        ...
        const userData = (await axios.get('User/GetUserInfo', {headers: {authorization: `Bearer ${jwt}`}})).data;
    ...
    return (
        <div className="authForm">
            ...
            <br/>
            <button className="spanLink" onClick={onGoToRegister}>Click here to register account</button>
        </div>
    )
}